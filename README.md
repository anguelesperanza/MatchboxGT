...
same encoding. Same `0-9 / A-Z` charset (lowercase/punctuation would need a bigger
font sheet). `draw_number(p, x,y, v,
...
| `text`    | runtime text — two lines of a dialogue box drawn from ROM with `draw_string` |
